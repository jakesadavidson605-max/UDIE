...
type ChatMessage = { role: "user" | "assistant"; content: string; source?: string; warning?: string | null };
...
export default function Home() {
  ...
  const chat = trpc.udie.chat.useMutation({
    onSuccess: data => setMessages(previous => [...previous, { role: "assistant", content: data.content, source: data.source, warning: data.warning }]),
